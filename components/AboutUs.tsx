            ...
            >
                ...
                <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-md rounded-2xl p-8 md:p-12 shadow-lg">
                    ...
                    >
                        ...
                        >
                            Jesteśmy zespołem pasjonatów motoryzacji, którzy przekształcili stje hobby w profesjonalną usługę. Naszą misją jest uproszczenie procesu importu wymarzonego samochodu z USA, czyniąc go dostępnym, bezpiecznym i w pełni transparentnym dla każdego klienta.
                        </motion.p>
