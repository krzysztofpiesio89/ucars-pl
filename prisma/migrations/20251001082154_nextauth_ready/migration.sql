...
-- AddForeignKey
ALTER TABLE "public"."Shipment" ADD CONSTRAINT "Shipment_auctionParticipationId_fkey" FOREIGN KEY ("auctionParticipationId") REFERENCES "public"."AuctionParticipation"("id") ON DELETE CASCADE ON UPDATE CASCADE;
